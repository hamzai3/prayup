...
class MyPlayerOffline extends StatefulWidget {
  final data, route;
  MyPlayerOffline({this.data, this.route});
  @override
  MyPlayerOfflineState createState() => MyPlayerOfflineState();
}

class MyPlayerOfflineState extends State<MyPlayerOffline>
    ...
    _playlist = ConcatenatingAudioSource(children: [
      ...
      if (kIsWeb ||
          ![TargetPlatform.windows, TargetPlatform.linux]
              ...
              widget.data != null)
        AudioSource.uri(
          Uri.parse(widget.data['url'].toString()),
          tag: AudioMetadata(
            album: widget.data['allbum'].toString(),
            title: widget.data['artist'].toString(),
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                widget.route != null && widget.route != 'N'
                    ? SizedBox(
                        height: 240.0,
