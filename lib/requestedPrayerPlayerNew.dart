...
class RequestedPlayerPageOffline extends StatefulWidget {
  ...
  @override
  RequestedPlayerPageOfflineState createState() =>
      RequestedPlayerPageOfflineState();
}

class RequestedPlayerPageOfflineState extends State<RequestedPlayerPageOffline>
    ...
    _playlist = ConcatenatingAudioSource(children: [
      ...
      if (kIsWeb ||
          ![TargetPlatform.windows, TargetPlatform.linux]
              ...
              widget.data != null)
        AudioSource.uri(
          Uri.parse(widget.data['file'].toString()),
          tag: AudioMetadata(
            album: widget.data['prayer_name'].toString(),
                              ...
                              children: [
                                CircleAvatar(
                                  ...
                                  backgroundImage: AssetImage("assets/slider/" +
                                      c.filename(widget.data['prayer_name']
                                          .toString())),
